...
declare const makeWASocket: (config: UserFacingSocketConfig) => {
    ...
    sendMarkdown: (jid: string, text: string, quoted?: any, options?: { botJid?: string, mentions?: string[] }) => Promise<{ message: import("../Types").WAProto.IMessage, messageId: string }>
    sendLatexImage: (jid: string, quoted?: any, options?: string | { text?: string, expressions?: import("../Utils/message-composer").LatexExpression[], headerText?: string, footer?: string, caption?: string }, renderLatexToPng?: any, uploadFn?: any) => Promise<any>
    sendLatexInlineImage: (jid: string, quoted?: any, options?: string | { text?: string, expressions?: import("../Utils/message-composer").LatexExpression[], headerText?: string, footer?: string }, renderLatexToPng?: any, uploadFn?: any) => Promise<any>
    sendRichMessage: (jid: string, submessages: any[], quoted?: any, options?: { botJid?: string, mentions?: string[], useMarkdown?: boolean, unifiedResponse?: any }) => Promise<{ message: import("../Types").WAProto.IMessage, messageId: string }>
