...
const makeMessagesSocket = (config) => {
    ...
    const sock = {
        ...
        sendLatexImage: async (jid, quoted, options) => {
            ...
            let dpiFormula = integrationFormula
            if (!dpiFormula.startsWith('\\dpi')) {
                dpiFormula = '\\dpi{600}' + dpiFormula
            }
            if (!dpiFormula.startsWith('\\bg')) {
                dpiFormula = '\\bg{white}' + dpiFormula
            }
